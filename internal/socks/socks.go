...
// Буферы пересылки переиспользуются: своя пара по 64 КиБ на каждую сессию при
// десятках тысяч соединений съедала памяти больше всего остального вместе взятого.
